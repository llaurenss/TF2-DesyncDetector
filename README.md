...
Made because JumpQoL doesn't work for 64 bit so until that is supported this can be useful for making legitimate TAS runs by filtering desyncs out for example.
